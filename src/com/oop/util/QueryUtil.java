...
public class QueryUtil extends CommonUtil {
	 ...
	 * 
	 * @see VideoServiceImpl#addEmployees()
	 * @see VideoServiceImpl#createEmployeeTable()
	 * @see VideoServiceImpl#displayAllEmployees()
	 * @see VideoServiceImpl#removeEmployee(String)
	 * 
	 */
	...
	public static String queryMemByID(String id) throws SAXException, IOException, ParserConfigurationException {
		 ...
		 * list. It refers tag name query
		 */
		nodeList = DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new File(System.getProperty("catalina.base") + "\\wtpwebapps\\OOPEmployeeWebApp\\WEB-INF\\MemberQuery.xml"))
				.getElementsByTagName(CommonConstants.TAG_NAME);
