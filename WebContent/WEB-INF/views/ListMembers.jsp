...
<%@page import="com.oop.service.MemberServiceImpl"%>
<%@page import="com.oop.service.IMemberService"%>
...
<html>
    ...
    <body class="fixed-left">
        <div id="wrapper">
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h3 class="page-title"><i class="ion-person-stalker">&nbsp;</i>View All Member Form</h3>
                                <ol class="breadcrumb">
                                    <li>
                                        <a href="#">VR</a>
                                    </li>
                                    <li>
                                        <a href="#">Member Manage</a>
                                    </li>
                                    <li class="active">
                                        View All Member Form
                                    </li>
                                </ol>
                            </div>
                        </div>
                       ...
                       <!--  <div id="con-close-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title" style="margin-bottom: 10px;"><b>Member Details</b></h4>                                                
                                    ...
                                    <table data-toggle="table"
                                        ...
                                        <thead>
                                            <tr>
                                            	<th data-field="memberId" data-sortable="true">Member ID</th>
                                                ...
                                                <th data-field="phoneNo" data-align="center" data-sortable="true">Phone No</th>
			...
			ArrayList<Member> arrayList = iMemberService.getMembers();
			...
			%>
			 <tr>
				...
				<td> 
				<form method="POST" action="GetMemberServlet">
			...
			<%-- 	 <button type="hidden" name="memberID" value="<%=member.getMemberID()%>" ></button> --%>
				...
				<button type="hidden" name="memberID" value="<%=member.getMemberID()%>"  class="btn btn-success btn-rounded waves-effect waves-light">
