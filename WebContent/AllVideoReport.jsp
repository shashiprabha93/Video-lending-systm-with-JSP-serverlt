...
{ 
    ...
    String query = "select * from video";          //Fetching data from table
    ...
    document.add(new Paragraph("                                       ALL CURRENT VIDEOS\n\n"));
    ...
    while(rs.next())
    {
        ...
        document.add(new Paragraph("VIDEO_ID ::"+rs.getString(1)+"\nSUB TITLE LANGUAGE ::"+rs.getString(5)+"\nFILM NAME ::"+rs.getString(2)+"\nFILM CATEGORY ::"+rs.getString(3)+"\nQUANTITY ::"+rs.getString(4)+"\n\n"));
    }
